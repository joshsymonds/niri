...
impl<W: LayoutElement> ScrollingSpace<W> {
    ...
    pub fn update_render_elements(
        ...
        for (col_idx, (col, col_x)) in self.columns_mut().enumerate() {
            ...
            col.update_render_elements(is_active, view_rect, focus_flash);
        }
    }
    ...
    pub fn active_tile(&self) -> Option<&Tile<W>> {
        ...
        let col = &self.columns[self.active_column_idx];
        Some(&col.tiles[col.active_tile_idx])
    }
...
impl<W: LayoutElement> Column<W> {
    ...
    pub fn update_render_elements(
        ...
        for (tile_idx, (tile, tile_off)) in self.tiles_mut().enumerate() {
            ...
            tile.update_render_elements(is_active, tile_view_rect, focus_flash);
        }
